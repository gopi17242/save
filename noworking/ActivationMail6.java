 ...
 public static void sendMail(String name,String domainName,String toMail) {
	...
	//      String fromMailPassword =password;
	      ...
	      Session session = Session.getDefaultInstance(props, 
	                           new Authenticator(){
	                              protected PasswordAuthentication getPasswordAuthentication() {
	                                 return new PasswordAuthentication("techfloppy6@gmail.com", "techfloppy@6");
	                              }});
	   ...
	   // -- Set the FROM and TO fields --
	      msg.setFrom(new InternetAddress("techfloppy6@gmail.com"));
	      ...
	      System.out.println("**********************************************************"+"techfloppy6@gmail.com");
	      Transport.send(msg);
